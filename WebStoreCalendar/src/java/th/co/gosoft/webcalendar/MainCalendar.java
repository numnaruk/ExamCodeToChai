 ...
 * @author kunawutjar
 */
public class MainCalendar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String userLogin = NullUtils.cvStr(request.getSession().getAttribute("Username"));
        String nameth = NullUtils.cvStr(request.getSession().getAttribute("nameth"));
        String storeid = NullUtils.cvStr(request.getParameter("storeid"));
        RequestDispatcher dp = null;
        try {
//          if (userLogin == null ? "" == null : userLogin.equals("")){
           if(storeid == null ? "" != null : !storeid.equals("")){
              ...
              storeid = NullUtils.cv5Digit(storeid);
                 ...
                 dp = getServletContext().getRequestDispatcher("/jsp/calendar.jsp");              
             }else{
              request.setAttribute("storeid",storeid );
              dp = getServletContext().getRequestDispatcher("/jsp/permission_deny.jsp");
             }
          }else if(userLogin == null ? "" != null : !userLogin.equals("")){
              request.setAttribute("storeid", "0000");
              request.setAttribute("nameth", nameth);
              dp = getServletContext().getRequestDispatcher("/jsp/calendar.jsp");
          }else{
              dp = getServletContext().getRequestDispatcher("/jsp/Login.jsp");
          }
//        }else{
//              request.setAttribute("storeid", "0000");
//              dp = getServletContext().getRequestDispatcher("/jsp/calendar.jsp");
